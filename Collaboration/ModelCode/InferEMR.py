...
def train(path,n,svi,sequences,lengths,args):
    '''
    n: number of samples to read
    path: file path
    svi: inference module in pyro
    sequences: data in tensor forms
    lengths: length of each sequences
    args: arguments, an argparse object
    '''
    
    sequences,lengths=data_loader(path,n)
    # training
    losses=[]
