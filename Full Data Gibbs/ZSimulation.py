...
if __name__=='__main__':
    ...
    for rate in [0,0.4,0.7,0.9]:
        ...
        for i in range(0,num):
            ...
            print(data[0])
            post_A,post_B,post_pi,latent_seq,log_prob=parallel_Gibbs(data,I,A,B,pi0,12000,hidden_state,obs_state,p)
