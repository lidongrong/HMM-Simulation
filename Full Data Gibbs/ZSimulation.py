...
transition=np.array([[0.6,0.3,0.1],[0.1,0.6,0.3],[0.1,0.3,0.6]])
...
if __name__=='__main__':
    ...
    for rate in [0,0.4,0.7,0.9]:
        ...
        for i in range(0,num):
            ...
            post_A,post_B,post_pi,latent_seq,log_prob=parallel_Gibbs(data,I,A,B,pi0,10000,hidden_state,obs_state,p)
