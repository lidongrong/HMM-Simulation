# -*- coding: utf-8 -*-
"""
Created on Thu Jan 27 15:27:55 2022
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 26 14:33:56 2022
@author: s1155151972
"""
...
state=np.array(['1','2'])
hidden_state=state
obs_state=np.array(['Blue','Red'])
obs_prob=np.array([[0.8,0.2],
                   [0.2,0.8]
    ])
...
if __name__=='__main__':
    ...
    for rate in [0,0.4]:
        ...
        for i in range(0,num):
            ...
            print(data[0])
            post_A,post_B,post_pi,latent_seq,log_prob=parallel_Gibbs(data,I,A,B,pi0,2000,hidden_state,obs_state,p)
