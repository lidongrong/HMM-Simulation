...
initial=np.array([0.2222222222222222, 0.3333333333333333, 0.4444444444444444])
'''
...
# set last row in the second dimension as 0 to ensure identifiability
alpha[:,-1,:]=0
...
num=8000
# missing rate
rate=[0.3,0.5,0.6,0.8,0.9,0.95,0.97]
# path
path='D:\Files\CUHK_Material\Research_MakeThisObservable\EMR\Data\SynthData'
