# -*- coding: utf-8 -*-
"""
Created on Fri Nov 26 11:00:49 2021
...
if __name__=='__main__':
    ...
    a1,b1,data1,I1=initialize()
    post_A1,post_B1,latent_seq1,log_prob1=parallel_Gibbs(data1,I1,a1,b1,5000)
    
    a2,b2,data2,I2=initialize()
    post_A2,post_B2,latent_seq2,log_prob2=parallel_Gibbs(data2,I2,a2,b2,5000)
    
    a3,b3,data3,I3=initialize()
    post_A3,post_B3,latent_seq3,log_prob3=parallel_Gibbs(data3,I3,a3,b3,5000)
