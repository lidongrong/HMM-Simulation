...
if __name__=='__main__':
    ...
    for rate in [0,0.3,0.5,0.7,0.9]:
        ...
        for i in range(0,num):
            ...
            prob=y_prob(data1[0:1000],transition,obs_prob,pi,hidden_state,obs_state,p)
            # data1=[]
            ...
            at,bt,pit,func=EMTrain(A,B,pi0,data1[0:1000],0.0005,hidden_state,obs_state,p)
